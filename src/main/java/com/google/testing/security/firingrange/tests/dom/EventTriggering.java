 ...
 * /pages.dom/eventtriggering/ directory and maps paths as follows:
 * <ul>
 *     <li> Source object
 *     <li> Source property
 *     <li> Sink
 * </ul>
 *
 * Thus, {@code /pages.dom/eventtriggering/document/cookie/eval} will map to the document.cookie source,
 * and the eval sink.
 */
