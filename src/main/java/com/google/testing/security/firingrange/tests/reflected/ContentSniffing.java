...
/**
 * Handles pages.reflected XSS on JSON via content sniffing. Note that this method reacts
 * to a callback parameter which is not directly linked from the HTML com.google.testing.security.firingrange.pages. Scanners
 * should be able to identify it themselves.
 */
public class ContentSniffing extends HttpServlet {
  @VisibleForTesting
  public static final String ECHOED_PARAM = "q";
