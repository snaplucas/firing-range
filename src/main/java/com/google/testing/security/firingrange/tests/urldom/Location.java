...
public class Location extends HttpServlet {
  private static final String BASE_TEMPLATE = "location.tmpl";
  ...
  private String generateTemplate(String source, String sink) throws IOException {
    ...
    String sourceTemplate = Templates.getTemplate(sourcePath, Location.class);
    
    String sinkPath = "sinks/" + sink + ".tmpl";
    String sinkTemplate = Templates.getTemplate(sinkPath, Location.class);
  
    String baseTemplate = Templates.getTemplate(BASE_TEMPLATE, Location.class);
