 ...
 * mapped to the whole /pages.dom/toxicdomscripts/ directory and maps paths as follows:
 * <ul>
 *     <li> Source object
 *     <li> Source property
 *     <li> Sink
 * </ul>
 *
 * Thus, {@code /pages.dom/toxicdomscripts/document/cookie/eval} will map to the document.cookie source,
 * and the eval sink.
 */
